...
// 详情页面动态绑定
$(function(){
    var lid=location.search.split("=")[1];//截取id
    $.ajax({
        url:"http://localhost:5050/public/shopping",
        data:{lid},
        type:"get",
        datatype:"json",
        success:function(result){ 
            ...
            for(var shop_0 of result){
                jp_0+=`<img src="${shop_0.img1}" alt="">`
            }
            $(".pic_s1").html(jp_0);  

            for(var shop_1 of result){
                jp_1+=`<img src="${shop_1.img1}" alt="">
